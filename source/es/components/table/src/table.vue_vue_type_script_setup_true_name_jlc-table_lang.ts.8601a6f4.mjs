...
import { i as isEmpty } from "../../../utils/tools.ts.d0af79cb.mjs";
import { g as getEpTableCommonFns } from "../../../utils/ep-table-common.ts.e9c47ca3.mjs";
import { p as propsType, e as emitsType } from "./table.ts.d33ed4fb.mjs";
const _withScopeId = (n) => (pushScopeId("data-v-db96baa7"), n = n(), popScopeId(), n);
const _hoisted_1 = {
  key: 0,
  class: "table__state"
};
