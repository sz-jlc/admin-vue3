...
const _withScopeId = (n) => (pushScopeId("data-v-d6b1e295"), n = n(), popScopeId(), n);
const _hoisted_1 = {
  key: 0,
  class: "table__state"
};
...
const _hoisted_3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createElementVNode("div", null, "\u65E0\u6570\u636E", -1));
const _hoisted_4 = [
  _hoisted_2,
  _hoisted_3
];
...
const _hoisted_7 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createElementVNode("div", null, "\u7F51\u7EDC\u9519\u8BEF", -1));
const _hoisted_8 = [
  _hoisted_6,
  _hoisted_7
];
      ...
      return withDirectives((openBlock(), createBlock(_component_el_table, mergeProps({
        ...
        empty: withCtx(() => [
          withDirectives(createElementVNode("div", null, [
            !_ctx.error ? (openBlock(), createElementBlock("div", _hoisted_1, _hoisted_4)) : (openBlock(), createElementBlock("div", _hoisted_5, _hoisted_8))
          ], 512), [
            [vShow, !_ctx.loading]
          ])
        ]),
