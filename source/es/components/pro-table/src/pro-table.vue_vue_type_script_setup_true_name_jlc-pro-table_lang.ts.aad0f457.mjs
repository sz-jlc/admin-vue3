import { defineComponent, computed, ref, onMounted, openBlock, createBlock, unref, createSlots, withCtx, renderSlot, createVNode, mergeProps, toHandlers, renderList } from "vue";
import { F as FilterPageList } from "../../../layouts/filter-page-list/filter-page-list.vue.7be786c0.mjs";
import { F as Filter } from "../../filter/src/filter.vue.df5d71a2.mjs";
import { T as Table } from "../../table/src/table.vue.388ece9f.mjs";
import { _ as _sfc_main$1 } from "../../page/src/page.vue_vue_type_script_setup_true_name_jlc-page_lang.ts.c31dbfb6.mjs";
import { u as useFilterPage } from "../../../hooks/use-filter-page.ts.cbf766c9.mjs";
